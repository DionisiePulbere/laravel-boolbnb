...
class apartmentsSeeder extends Seeder
{
    ...
    public function run(Faker $faker)
    {
        ...
        $newApartment2->description = 'Hai diritto a uno sconto Genius su Starhotels Grand Milan! Per risparmiare su questa struttura ti basta accedere.
                                       Situato a Saronno, l’hotel di design Starhotels Grand Milan offre una piscina coperta e si trova a 500 metri dalla Stazione di Saronno, con collegamenti per Milano. La struttura dispone di connessione WiFi gratuita, centro fitness, spa con sauna e bagno turco.
                                       Questo hotel a 4 stelle dista 2 km dall’uscita dell’autostrada A9 e 15 minuti di auto dalla Fiera di Milano Rho. Un servizio navetta disponibile a un costo aggiuntivo e su richiesta. Il servizio è soggetto a disponibilità.
                                       Caratterizzate da un design contemporaneo, le camere e suite presentano un moderno bagno. Tutte le sistemazioni sono provviste di aria condizionata e minibar.
                                       Inizierete la giornata con una colazione a buffet, e potrete gustare una selezione di piatti locali presso il ristorante Hostaria o scegliere l’Hostaria Cafè, ideale per rilassarvi con una bevanda.
                                       Il Grand Milan comprende anche imponenti strutture business per un totale di 14 sale riunioni, 11 delle quali dotate di illuminazione naturale.
                                       Troverete la piscina, l area fitness e il centro benessere al 9° piano della struttura.
        ...
        $newApartment3->description = 'Featuring air-conditioned accommodation with a private pool, Villa De Luca - Luxury villa with terrace and Jacuzzi by the sea is set in Vico Equense. This beachfront property offers access to a balcony, free private parking and free WiFi. The property is non-smoking and is situated 100 metres from Le Axidie Beach.
                                       The spacious villa with a terrace and sea views features 3 bedrooms, a living room, a flat-screen TV, an equipped kitchen with a dishwasher and an oven, and 4 bathrooms with a bidet. Towels and bed linen are featured in the villa. For added privacy, the accommodation features a private entrance.
                                       Chicchi Beach is 300 metres from the villa, while Marina di Vico - Le Postali Beach is 1.3 km away. The nearest airport is Naples International Airport, 41 km from Villa De Luca - Luxury villa with terrace and Jacuzzi by the sea.';
